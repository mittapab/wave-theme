<?php  get_header();  ?>
  ...
  <main id="main">
    ...
    <section class="px-2 py-8 py-xxl-16 background-position-center background-size-cover background-attachment-fixed bsb-overlay" style="background-image: url('<?php echo get_theme_file_uri('/assets/img/cta/cta-img-1.jpg');?>');">
      <div class="container">
        <div class="row">
        ...
        <div class="row gy-2 g-md-2 g-xl-3 bsb-project-2-grid">
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-hover-overlay m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale-up bsb-hover-scale" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/portfolio/project-landscape-1.jpg'); ?>" alt="">
              </a>
              <figcaption>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-hover-overlay m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/portfolio/project-portrait-1.jpg');?>" alt="">
              </a>
              <figcaption>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-hover-overlay m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale-up bsb-hover-scale" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/portfolio/project-landscape-2.jpg'); ?>" alt="">
              </a>
              <figcaption>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-hover-overlay m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/portfolio/project-portrait-2.jpg');?>" alt="">
              </a>
              <figcaption>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-hover-overlay m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/portfolio/project-portrait-3.jpg');?>" alt="">
              </a>
              <figcaption>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-hover-overlay m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/portfolio/project-portrait-4.jpg');?>" alt="">
              </a>
              <figcaption>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-hover-overlay m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale-up bsb-hover-scale" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/portfolio/project-landscape-3.jpg');?>" alt="">
              </a>
              <figcaption>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-hover-overlay m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale-up bsb-hover-scale" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/portfolio/project-landscape-4.jpg');?>" alt="">
              </a>
              <figcaption>
      ...
      <div class="container">
        <div class="row gy-5 gy-lg-0 gx-lg-6 gx-xxl-8 align-items-lg-center">
          <div class="col-12 col-lg-6">
            <img class="img-fluid rounded" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/about/about-img-1.png');?>" alt="">
          </div>
          <div class="col-12 col-lg-6">
        ...
        <div class="row gy-4 gy-lg-0 gx-xxl-5">
            ...
            <div class="card border-0 border-bottom border-primary shadow-sm overflow-hidden">
              <div class="card-body p-0">
                <figure class="m-0 p-0">
                  <img class="img-fluid" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/team/team-img-1.jpg'); ?>" alt="">
          ...
          <div class="col-12 col-md-6 col-lg-3">
            <div class="card border-0 border-bottom border-primary shadow-sm overflow-hidden">
              <div class="card-body p-0">
                <figure class="m-0 p-0">
                  <img class="img-fluid" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/team/team-img-2.jpg'); ?>" alt="">
                  <figcaption class="m-0 p-4">
          ...
          <div class="col-12 col-md-6 col-lg-3">
            <div class="card border-0 border-bottom border-primary shadow-sm overflow-hidden">
              <div class="card-body p-0">
                <figure class="m-0 p-0">
                  <img class="img-fluid" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/team/team-img-3.jpg');?>" alt="">
                  <figcaption class="m-0 p-4">
          ...
          <div class="col-12 col-md-6 col-lg-3">
            <div class="card border-0 border-bottom border-primary shadow-sm overflow-hidden">
              <div class="card-body p-0">
                <figure class="m-0 p-0">
                  <img class="img-fluid" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/team/team-img-4.jpg');?>" alt="">
                  <figcaption class="m-0 p-4">
        ...
        <div class="row gy-4">
          <div class="col-12 col-lg-4">
            <div class="card border-0 border-bottom border-primary shadow-sm wave-bg-lotion">
              <div class="card-body p-4 p-xxl-5">
                <figure>
                  <img class="img-fluid rounded rounded-circle mb-4 border border-5" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/testimonial/testimonial-img-1.jpg');?>" alt="">
                  <figcaption>
          ...
          <div class="col-12 col-lg-4">
            <div class="card border-0 border-bottom border-primary shadow-sm wave-bg-lotion">
              <div class="card-body p-4 p-xxl-5">
                <figure>
                  <img class="img-fluid rounded rounded-circle mb-4 border border-5" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/testimonial/testimonial-img-2.jpg');?>" alt="">
                  <figcaption>
                    <blockquote class="bsb-blockquote-icon mb-4">Nam ultricies, ex lacinia dapibus faucibus, sapien ipsum euismod massa, at aliquet erat turpis quis diam. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</blockquote>
          ...
          <div class="col-12 col-lg-4">
            <div class="card border-0 border-bottom border-primary shadow-sm wave-bg-lotion">
              <div class="card-body p-4 p-xxl-5">
                <figure>
                  <img class="img-fluid rounded rounded-circle mb-4 border border-5" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/testimonial/testimonial-img-4.jpg');?>" alt="">
                  <figcaption>
                    <blockquote class="bsb-blockquote-icon mb-4">Nam ultricies, ex lacinia dapibus faucibus, sapien ipsum euismod massa, at aliquet erat turpis quis diam. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</blockquote>
            ...
            <div class="row gy-4 gy-xxl-5 gx-xxl-5">
              <div class="col-12 col-lg-6">
                <article>
                  <figure class="rounded overflow-hidden mb-3 bsb-hover-overlay">
                    <a href="#!">
                      <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/blog/blog-image-1.jpg');?>" alt="">
                    </a>
                    <figcaption>
              ...
              <div class="col-12 col-lg-6">
                <article>
                  <figure class="rounded overflow-hidden mb-3 bsb-hover-overlay">
                    <a href="#!">
                      <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/blog/blog-image-2.jpg');?>" alt="">
                    </a>
                    <figcaption>
              ...
              <div class="col-12 col-lg-6">
                <article>
                  <figure class="rounded overflow-hidden mb-3 bsb-hover-overlay">
                    <a href="#!">
                      <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/blog/blog-image-3.jpg');?>" alt="">
                    </a>
                    <figcaption>
              ...
              <div class="col-12 col-lg-6">
                <article>
                  <figure class="rounded overflow-hidden mb-3 bsb-hover-overlay">
                    <a href="#!">
                      <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/blog/blog-image-4.jpg');?>" alt="">
                    </a>
                    <figcaption>
    ...
    <section id="scrollspyContact" class="py-5 py-xl-8 py-xxl-16">
      <div class="container">
        <div class="row gy-5 gy-lg-0 gx-lg-6 gx-xxl-8 align-items-lg-center">
          <div class="col-12 col-lg-6">
            <img class="img-fluid rounded" loading="lazy" src="<?php echo get_theme_file_uri('/assets/img/contact/contact-img-1.jpg');?>" alt="">
          </div>
          <div class="col-12 col-lg-6">
